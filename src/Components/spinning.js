...
const Spinning = () => {
  ...
  return (
    <div id="main">
      ...
      <div id="page8">
        <h1>
          <span>Enclosure</span> Laundromint are modern, well-equipped laundries
          with state-of-the-art machines. The operation of the washing machines
          and dryers is intuitive.
        </h1>
      </div>
      <div id="page9">
        <h1>
          <span>Light Seal.</span> Laundromint are modern, well-equipped
          laundries with state-of-the-art machines. The operation of the washing
          machines and dryers is intuitive.
        </h1>
      </div>
      <div id="page10">
        <h1>
          <span> Head Band. </span>Laundromint are modern, well-equipped
          laundries with state-of-the-art machines. The operation of the washing
          machines and dryers is intuitive.
        </h1>
      </div>
      <div id="page11">
        <h1>
          <span> Power. </span>Laundromint are modern, well-equipped laundries
          with state-of-the-art machines. The operation of the washing machines
          and dryers is intuitive.
        </h1>
      </div>
      <div id="page12">
        <h1>
          <span>Sound. </span>Laundromint are modern, well-equipped laundries
          with state-of-the-art machines. The operation of the washing machines
          and dryers is intuitive. .
        </h1>
      </div>
